/*
  ...
  1. New Tables
    ...
    - `matches` - Matched lost and found items
...
-- Matches policies
CREATE POLICY "Users can read matches they're involved in"
  ON matches
  FOR SELECT
  TO authenticated
...
BEGIN
  ...
  LOOP
    -- Create a match
    INSERT INTO matches (lost_item_id, found_item_id, finder_id, owner_id, points_awarded)
